...
var prefixWithSlot = 'oslo${prefix}-${slot}'
var vnetName = 'oslo${prefixWithSlot}-vnet'
var aksMIName = 'oslo${prefixWithSlot}-aks-mi'
var aksName = 'oslo${prefixWithSlot}-aks'
var aksEgressPipName = 'oslo${prefixWithSlot}-aks-egress-pip'
var nodeResourceGroupName = 'oslo${prefixWithSlot}-aks-rg'
